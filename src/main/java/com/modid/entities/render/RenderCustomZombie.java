package com.modid.entities.render;

import com.modid.ModName;
import com.modid.entities.CustomZombie;
...
public class RenderCustomZombie extends RenderLiving<CustomZombie> {
	public static final ResourceLocation TEXTURES = new ResourceLocation(ModName.MODID + ":textures/entity/custom_zombie.png");
